# 📝 Diario di Apprendimento – Deutsch

Questo diario documenta il mio percorso di apprendimento della lingua tedesca.  
**Parto completamente da zero**, senza alcuna conoscenza iniziale, e il percorso è iniziato ufficialmente il **18 novembre 2025**.

---

## 📌 Racconto dei primi 10 giorni

Nei primi dieci giorni il primo approccio è stato abbastanza tranquillo. Ho iniziato con le primissime frasi come *Guten Morgen*, *Guten Abend*, *Tschüss* e, naturalmente, *Ich bin…*, che è stata la mia primissima frase completa: **Ich bin Mauro**.  

Quasi subito ho voluto dare uno sguardo anche alla grammatica, e mi sono imbattuto in *Der, Die, Das*. Lì mi sono reso conto che non sarebbe stato facile, ma già solo avere un assaggio della struttura della lingua mi ha motivato a continuare.  

Un’altra difficoltà iniziale è stata la **pronuncia**, che ho capito essere fondamentale per memorizzare parole e frasi. Alcuni suoni tipici, come quello di *Ich*, richiedono di far passare l’aria lateralmente dalla bocca, mentre altri come la *R* sono completamente diversi da quelli a cui sono abituato. Anche i caratteri con le umlaut (ä, ö, ü) richiedono attenzione e pratica. Ho capito quanto sia importante ripetere le parole e le frasi ad alta voce, proprio per fissarle meglio nella memoria.  

Durante questi giorni ho iniziato a usare varie risorse. Gran parte del mio studio quotidiano è stato supportato da **Duolingo**, con un minimo di 30 minuti di esercizio al giorno. Ho cominciato anche a seguire qualche influencer tedesco su TikTok e a guardare video su YouTube: ho trovato molto utile il canale [EasyGerman](https://www.youtube.com/@EasyGerman). Ho visto anche un video di **Paola Di Lello** ([link](https://www.youtube.com/watch?v=eYy7TjpzzsM)), in cui spiega l’importanza dell’ascolto nell’apprendimento di una lingua, proprio come fanno i bambini: il consiglio principale era iniziare con cartoni animati nella lingua madre. Seguendo questo consiglio, ora guardo almeno due volte al giorno episodi di **Peppa Pig in tedesco** ([link](https://www.youtube.com/watch?v=SsInLT1CO6I)).  

Di recente ho anche iniziato a usare **Busuu**, un’altra app per l’apprendimento delle lingue, ma è ancora presto per valutare la sua efficacia. In parallelo tengo un quaderno dove prendo appunti di parole e frasi nuove, così da fissarle meglio nella memoria.

Tra le parole che ho incontrato finora, la mia preferita è stata *Tochter*, mentre tra le frasi la mia preferita è stata *Das ist meine Schwester*.  

Tutto il materiale accumulato nei primi dieci giorni, comprese parole e frasi, sarà riportato e aggiornato regolarmente negli appositi file: `VOCABOLI.md` , `FRASI.md` e `RISORSE` insieme a tutti i progressi futuri.

---

Questo resoconto riassume sommariamente i primi dieci giorni del mio approccio al tedesco.  
Da oggi (28 novembre 2025) ho deciso di creare questo progetto su GitHub per documentare tutto in modo organizzato, e il diario verrà aggiornato periodicamente, passo dopo passo, con nuovi progressi, parole, frasi e riflessioni.

---

# 📝 Diario – 29/11/2025

Oggi ho studiato un po’ di tedesco su Duolingo e Busuu e ho imparato nuovi vocaboli e frasi.  
Per chiarire alcune difficoltà grammaticali, ho chiesto aiuto a ChatGPT, che mi ha dato delle **regole fondamentali** da ricordare sempre.  

---

## 📚 Vocaboli e frasi imparati oggi
...
Oggi ho annotato alcune **regole chiave da tenere sempre a mente** che dovrò studiare bene:  

1. **Verbo sempre al secondo posto** nella frase principale.  
2. **Memorizzare i sostantivi con articolo e plurale**, così il genere e il plurale diventano immediatamente automatici.  
3. **Struttura della frase**: soggetto + verbo + complementi (valido per frasi principali; nelle subordinate il verbo va alla fine).  
4. **Ordine dei complementi**: Tempo → Kausa → Modo → Luogo (se presenti insieme).  
5. **Domande dirette**: il verbo precede il soggetto (es. „Wo wohnst du?“).  
6. **Aggettivi e accordo**: gli aggettivi cambiano forma a seconda di **genere, numero e caso** del sostantivo.  
